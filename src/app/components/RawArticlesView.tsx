    ...
    <div className="flex-1 overflow-auto bg-neutral-50">
      <div className="p-8">
        <div className="mb-8">
          ...
          <p className="text-neutral-600">수집된 원문 기사와 출처 링크</p>
        </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-neutral-200">
                  ...
                  <th className="text-left py-3 px-4 text-sm font-medium text-neutral-600">원문 작성 시간</th>
                  <th className="text-left py-3 px-4 text-sm font-medium text-neutral-600">원문 링크</th>
                </tr>
              </thead>
              <tbody>
                  ...
                  <tr key={article.id} className="border-b border-neutral-100 hover:bg-neutral-50">
                    ...
                    <td className="py-3 px-4">
                      <a
                        ...
                        className="inline-flex items-center gap-2 rounded-lg border border-neutral-300 px-3 py-2 text-sm font-medium text-neutral-700 hover:bg-neutral-50 hover:text-orange-600"
                      >
                        바로가기
