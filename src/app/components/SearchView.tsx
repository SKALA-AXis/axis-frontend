...
export function SearchView() {
  ...
  const suggestedQueries = [
    ...
    '삼성 SDS의 제조 AX 메시지가 SK AX에 주는 영향은?',
    '금융권 AI 보안 패키지 관련 Peer사 동향 정리해줘',
    '포스코 DX를 포함한 4개 Peer사 차별 포인트 비교해줘',
  ];
