 ...
 * 작성자: 안가은
 * 변경이력:
 *   2026-04-27 안가은 — 프론트 폴더 구조 재정비 시 대시보드 모델 정의, 이후 그래프 데이터 연동·키워드 스파이크·키워드 트렌드 UI·믹서/브리핑 표시 정리 반영
 *   2026-06-05 박진 — 홈 투데이 인사이트 백엔드 연결 및 mock 비활성화·믹서 UX 개선
 *   2026-06-09 최종민 — 투데이 인사이트 dual-lane 비교 컨텍스트 및 홈 3상태 렌더 모델 반영
 */
