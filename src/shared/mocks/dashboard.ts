...
export const mockDashboardData: DashboardData = {
  ...
  dartSummary: {
    ...
    revenueTotalKrwBn: 54646.38,
    operatingProfitKrwBn: 5204.33,
    operatingMarginPct: 9.52,
    netMarginPct: 8.7,
    debtRatioPct: 17.27,
    cashRatioPct: 28.64,
    intangibleAssetRatioPct: 6.68,
    capexRatioPct: 5.49,
    documentTableCount: 3183,
    documentImageCount: 14,
    chartPoints: [
      { label: '매출', value: 54646.38, unit: '억원', color: 'var(--axis-graph-company)' },
      { label: '영업이익', value: 5204.33, unit: '억원', color: 'var(--axis-graph-ax)' },
    ],
    radarMetrics: [
      { axis: '수익성', metric: '영업이익률', actualValuePct: 9.52, displayValue: '9.52%', score: 63 },
      { axis: '최종수익성', metric: '순이익률', actualValuePct: 8.7, displayValue: '8.7%', score: 73 },
      { axis: '재무안정성', metric: '부채비율', actualValuePct: 17.27, displayValue: '17.27%', score: 86 },
      { axis: '투자여력', metric: '현금비율', actualValuePct: 28.64, displayValue: '28.64%', score: 29 },
      { axis: '기술자산화', metric: '무형자산비율', actualValuePct: 6.68, displayValue: '6.68%', score: 33 },
      { axis: '투자공격성', metric: 'CAPEX 비율', actualValuePct: 5.49, displayValue: '5.49%', score: 37 },
    ],
  },
};
